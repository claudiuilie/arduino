...
if((results.value == 16718055) && (onOffCounter2 == 0 )){
      digitalWrite(RELAY_CH2, HIGH);
      onOffCounter2 = 1;
      results.value = 0;
      Serial.println(onOffCounter2);
}
if ((results.value == 16718055) && (onOffCounter2 == 1 )){
...
if((results.value == 16743045) && (onOffCounter3 == 0 )){
      digitalWrite(RELAY_CH3, HIGH);
      onOffCounter3 = 1;
      results.value = 0;
      Serial.println(onOffCounter3);
}
if ((results.value == 16743045) && (onOffCounter3 == 1 )){
...
if((results.value == 16716015) && (onOffCounter4 == 0 )){
      digitalWrite(RELAY_CH4, HIGH);
      onOffCounter4 = 1;
      results.value = 0;
      Serial.println(onOffCounter4);
}
if ((results.value == 16716015) && (onOffCounter4 == 1 )){
...
if((results.value == 16726215) && (onOffCounter5 == 0 )){
      digitalWrite(RELAY_CH5, HIGH);
      onOffCounter5 = 1;
      results.value = 0;
      Serial.println(onOffCounter5);
}
if ((results.value == 16726215) && (onOffCounter5 == 1 )){
...
if((results.value == 16734885) && (onOffCounter6 == 0 )){
      digitalWrite(RELAY_CH6, HIGH);
      onOffCounter6 = 1;
      results.value = 0;
      Serial.println(onOffCounter6);
}
if ((results.value == 16734885) && (onOffCounter6 == 1 )){
...
if (irrecv.decode(&results))
    {
     //afișăm valoarea in hexazecimal în serial monitor
     //puteți să afișați datele și în alte baze de numărare, cum ar fi : DEC ( în baza 10 )
     Serial.println(results.value);

     //pregătim receptorul pentru a detecta următorul semnal IR
     irrecv.resume();
    } 
    ...
    while (client.connected()) {
      ...
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.print("<center> <p><h1>Arduino Home</h1></p> ");
          //client.println("<br />");
          //client.println("<br />");
